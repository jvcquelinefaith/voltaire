...
class SimpleLayer_2 implements Layer {
	...
	public SimpleLayer_2(String host, int port) {
		this.subLayer = new ConnectedLayer(host, port, (int) (Math.random() * Integer.MAX_VALUE));
		this.subLayer.deliverTo(this);
	}

	@Override
	public void send(String payload) {
		this.subLayer.send(payload);
	}
...
public class Talk_2 {
	...
	public static void main(String[] args) {
		if (args.length != 3) {
			System.err.println("syntax : java Talk_2 myPort destinationHost destinationPort");
			return;
		}
